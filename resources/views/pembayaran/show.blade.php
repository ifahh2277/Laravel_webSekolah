            ...
            <div class="card">
                ...
                <div class="card-body">
                    ...
                    <div class="row mb-3">
                        ...
                        <div class="col-md-6">
                            <strong>Jumlah:</strong> {{ $pembayaran->getFormattedJumlahAttribute() }}
                        </div>
                    </div>
                    <div class="row mb-3">
                        <div class="col-md-6">
                            <strong>Tanggal Bayar:</strong> {{ $pembayaran->tanggal_bayar->format('d/m/Y') }}
                        </div>
                        <div class="col-md-6">
            ...
            @if ($pembayaran->bukti_pembayaran)
                <div class="card">
                    ...
                    <div class="card-body text-center">
                        <img src="{{ Storage::disk('public')->url($pembayaran->bukti_pembayaran) }}" alt="Bukti Pembayaran" class="img-fluid rounded">
                        <div class="mt-3">
                            <a href="{{ Storage::disk('public')->url($pembayaran->bukti_pembayaran) }}" target="_blank" class="btn btn-sm btn-info">
