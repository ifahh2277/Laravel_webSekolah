...
<body>
    ...
    <div class="sidebar" id="sidebar">
        ...
        <ul class="nav-menu">
            ...
            <li><a href="{{ route('pembayaran.index') }}" class="{{ request()->routeIs('pembayaran.*') ? 'active' : '' }}">
                <i class="fas fa-credit-card"></i> Pembayaran
            </a></li>
            
            <li><a href="{{ route('dashboard.status.pembayaran') }}" class="{{ request()->routeIs('dashboard.status.pembayaran') ? 'active' : '' }}">
                <i class="fas fa-chart-pie"></i> Status Pembayaran
            </a></li>
            
            <li><a href="{{ route('pendaftaran') }}" class="{{ request()->routeIs('pendaftaran') ? 'active' : '' }}">
